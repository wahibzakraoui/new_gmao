...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Baum\Mixins\Collection::toHierarchy()
         * @static 
         */ 
        public static function toHierarchy()
        {
                        return \Illuminate\Support\Collection::toHierarchy();
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         * 
         *
         * @see \Baum\Mixins\Blueprint::nestedSet()
         * @static 
         */ 
