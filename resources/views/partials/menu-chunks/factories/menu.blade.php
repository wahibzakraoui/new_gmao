...
<li class="menu-item menu-item-submenu {{ Route::currentRouteName() == 'factories' || Route::currentRouteName() == 'add-factory' ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
            ...
            <li class="menu-item {{ Route::currentRouteName() == 'factories' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('factories') }}" class="menu-link">
                    <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                    </i>
                    <span class="menu-text">List of factories</span>
                </a>
            </li>
            <li class="menu-item {{ Route::currentRouteName() == 'add-factory' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('add-factory') }}" class="menu-link">
                    <i class="menu-bullet menu-bullet-dot">
                        <span></span>
                    </i>
                    <span class="menu-text">Add factory</span>
                </a>
            </li>
        </ul>
    </div>
