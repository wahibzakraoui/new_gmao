<li class="menu-item menu-item-submenu {{ Route::currentRouteName() == 'equipments' || Route::currentRouteName() == 'add-equipment' ? 'menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
        ...
        <ul class="menu-subnav">
            ...
            <li class="menu-item {{ Route::currentRouteName() == 'equipments' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="#" class="menu-link">
                    ...
                    <span class="menu-text">List of equipments</span>
                </a>
            </li>
            <li class="menu-item {{ Route::currentRouteName() == 'add-equipment' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="#" class="menu-link">
                    ...
                    <span class="menu-text">Add equipment</span>
                </a>
            </li>
        </ul>
    </div>
