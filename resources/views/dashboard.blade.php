...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
            <div class="alert {{ Session::get('alert-class', 'alert-info') }} mb-5 p-5" role="alert">
                <h4 class="alert-heading">{{ Session::get('message-header') }}</h4>
                <p>{{ Session::get('message-body') }}</p>
                <div class="border-bottom border-white opacity-20 mb-5"></div>
                <p class="mb-0">{{ Session::get('message-footer') }}</p>
            </div>
            </div>
        </div>
        @endif
