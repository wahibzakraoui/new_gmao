        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="" class="text-muted">Spares</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
<div class="container-fluid">
    ...
    <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
        ...
        <div class="alert-text">This page allows you to manage the spare parts that make up your equipment.</div>
    </div>
    <!--end::Notice-->
    <!--begin::Card-->
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            <div class="card-title">
                <h3 class="card-label">List of current Spares (definitions)
            ...
            <div class="card-toolbar">
                @can('add equipment')
                <!--begin::Button-->
                <a href="{{route('add-spare')}}" class="btn btn-primary font-weight-bolder">
