...
<div class="container">
    ...
    <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
        ...
        <div class="alert-text">This page lets you create the different Sites that constitute your infrastructure.
            <br />A Factory will house and contain all the different Areas and Equipments.
            It is the Root of your park.
        </div>
    </div>
    <!--end::Notice-->
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3">
            <div class="card-title">
                <h3 class="card-label">New factory:
        ...
        <div class="card-body">
            {{ Form::model($factory, array('route' => array('update-factory', $factory->id), 'method' => 'POST', 'id' => 'edit_factory_form')) }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <span class="form-text text-muted">Is this factory active?</span>
                    </div>
                </div>
            </div>
...
<script>
    FormValidation.formValidation(
        document.getElementById('edit_factory_form'),
        {
            fields: {
                name: {
                    validators: {
