					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://www.techify.ma" target="_blank" class="text-dark-75 text-hover-primary">TECHIFY.MA</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<div class="nav nav-dark">
								<a href="https://techify.ma/web-design/" target="_blank" class="nav-link pl-0 pr-5">A propos de nous</a>
								<a href="https://techify.ma/carrieres/" target="_blank" class="nav-link pl-0 pr-5">Carrieres</a>
								<a href="https://techify.ma/contact/" target="_blank" class="nav-link pl-0 pr-0">Contact</a>
							</div>
							<!--end::Nav-->
						</div>
						<!--end::Container-->
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
